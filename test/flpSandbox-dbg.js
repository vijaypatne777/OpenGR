		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Open GR Report",
									"targetURL": "#OpenGRReport-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"OpenGRReport-display": {
								"semanticObject": "OpenGRReport",
								"action": "display",
								"description": "Open GR Report",
								"title": "Open GR Report",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=OpenGR.OpenGR",
									"url": sap.ui.require.toUrl("OpenGR/OpenGR")
								}
							}
						}
					}
